import 'package:vasravitan/views/auth/vendor/forgot_password.dart';
import 'package:vasravitan/views/auth/vendor/vendor_auth.dart';
import 'package:vasravitan/views/customer/orders/orders.dart';
import 'package:vasravitan/views/vendor/profile/store_data_analysis.dart';
...
final routes = {
  ...
  RouteManager.customerMainScreen: (context) => const CustomerMainScreen(index: 0),
  ...
  //RouteManager.vendorEntryScreen: (context) => const VendorMainScreen(index: 0),
